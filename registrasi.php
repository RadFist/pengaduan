...
<div class="login-form">
    ...
    <form action="" method="post">
        ...
        <div class="form-group">
        	 <input type="password" class="form-control" name="pass1" placeholder="ulangi password" required="required">
        </div>
        <div class="form-group">
    ...
    <p class="text-center small">Don't have an account? <a href="login.php" class="text-primary">Sign up here!</a></p>
</div>
</body>
</html>
<?php ?>
